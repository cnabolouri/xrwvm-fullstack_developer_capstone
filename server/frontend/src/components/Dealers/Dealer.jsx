...
const Dealer = () => {
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem("username")) {
      setPostReview(
        <a href={post_url}>
          <img src={review_icon} style={{ width: '10%', marginLeft: 10, marginTop: 10 }} alt="Post Review"/>
        </a>
      );
    }
  ...
  return (
    <div style={{ margin: 20 }}>
      ...
      <div style={{ marginTop: 10 }}>
        ...
        {dealer && (
          <h4 style={{ color: "grey" }}>
            {dealer.city}{dealer.city ? ", " : ""}{dealer.address}
            {dealer.zip ? `, Zip - ${dealer.zip}` : ""}{dealer.state ? `, ${dealer.state}` : ""}
          </h4>
        )}
      </div>
